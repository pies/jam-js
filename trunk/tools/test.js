...
function pack(_script, _encoding, _fastDecode, _specialChars) {
    ...
    // characters: ÂˇÂ˘ÂŁÂ¤ÂĄÂ¦Â§Â¨Â©ÂŞÂ«Â¬Â­Â®ÂŻÂ°Â±Â˛ÂłÂ´ÂµÂ¶Â·Â¸ÂąÂşÂ»ÂĽÂ˝ÂľÂżĂ€ĂĂ‚ĂĂ„Ă…Ă†Ă‡ĂĂ‰ĂŠĂ‹ĂŚĂŤĂŽĂŹĂĂ‘Ă’Ă“Ă”Ă•Ă–Ă—ĂĂ™ĂšĂ›ĂśĂťĂžĂźĂ ĂˇĂ˘ĂŁĂ¤ĂĄĂ¦Ă§Ă¨Ă©ĂŞĂ«Ă¬Ă­Ă®ĂŻĂ°Ă±Ă˛ĂłĂ´ĂµĂ¶Ă·Ă¸ĂąĂşĂ»ĂĽĂ˝Ăľ
...
help();
//defineClass('readFile');
//var js = System.readFile('unpacked.js');
//print(js);
